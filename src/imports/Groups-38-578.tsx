...
function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-start min-h-px min-w-px relative">
      ...
      <div className="flex flex-[1_0_0] h-[30.323px] items-center justify-center min-h-px min-w-px relative" style={{ "--transform-inner-width": "168.875", "--transform-inner-height": "22.5" } as React.CSSProperties}>
        <div className="flex-none skew-x-[348.255deg] w-full">
          <div className="flex flex-col font-['PingFang_SC:Regular',sans-serif] justify-center leading-[0] not-italic relative text-[#464f5d] text-[22px] w-full">
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-start min-h-px min-w-px relative">
      ...
      <div className="flex flex-[1_0_0] h-[30.323px] items-center justify-center min-h-px min-w-px relative" style={{ "--transform-inner-width": "152.875", "--transform-inner-height": "22.5" } as React.CSSProperties}>
        <div className="flex-none skew-x-[348.255deg] w-full">
          <div className="flex flex-col font-['PingFang_SC:Regular',sans-serif] justify-center leading-[0] not-italic relative text-[#464f5d] text-[22px] w-full">
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-start min-h-px min-w-px relative">
      ...
      <div className="flex flex-[1_0_0] h-[30.323px] items-center justify-center min-h-px min-w-px relative" style={{ "--transform-inner-width": "161.75", "--transform-inner-height": "22.5" } as React.CSSProperties}>
        <div className="flex-none skew-x-[348.255deg] w-full">
          <div className="flex flex-col font-['PingFang_SC:Regular',sans-serif] justify-center leading-[0] not-italic relative text-[#464f5d] text-[22px] w-full">
