import imgImgLine2 from "figma:asset/c0762e2474149013581116f4ef06f1142dba6d65.png";
...
export default function Groups() {
  return (
    <div className="bg-[rgba(0,0,0,0)] relative size-full" data-name="Groups">
      <div className="absolute bottom-[5.63px] h-[18.018px] right-[64.19px] w-[579.955px]" data-name="img_line_2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImgLine2} />
      </div>
