...
function Button() {
  return (
    <div className="content-stretch flex h-[90px] items-center justify-center pr-[216px] relative shrink-0 w-[217px]" data-name="button_4">
      <Component />
      <Frame5 />
    </div>
  );
...
function ImgRenwu1() {
  return (
    <div className="mr-[-4px] relative shrink-0 size-[84px]" data-name="img_renwu_1">
      <div className="absolute h-[71.4px] left-[0.89px] top-[5.28px] w-[82.95px]" data-name="彩色动漫">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Button2() {
  return (
    <div className="content-stretch flex flex-col h-[90px] items-start justify-center pr-[24px] relative shrink-0 w-[235px]" data-name="button_5">
      <Component2 />
      <Frame4 />
    </div>
  );
...
function ImgRenwu3() {
  return (
    <div className="mr-[-6px] relative shrink-0 size-[84px]" data-name="img_renwu_1">
      <div className="absolute h-[81.9px] left-[-4.2px] top-[-3.99px] w-[95.55px]" data-name="新海诚风格">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function ImgRenwu4() {
  return (
    <div className="mr-[-4px] relative shrink-0 size-[84px]" data-name="img_renwu_1">
      <div className="absolute h-[71.4px] left-[-3.15px] top-[3.15px] w-[86.1px]" data-name="Q版可爱">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Frame8() {
  return (
    <div className="content-stretch flex items-center mr-[-179px] pr-[4px] relative shrink-0">
      <ImgRenwu4 />
      <div className="css-g0mm18 flex flex-col font-['PingFang_SC:Semibold',sans-serif] justify-center leading-[0] mr-[-4px] not-italic relative shrink-0 text-[#3d3e3c] text-[26px] text-right">
...
function Button4() {
  return (
    <div className="content-stretch flex h-[90px] items-center justify-center pr-[211px] relative shrink-0 w-[217px]" data-name="button_4">
      <Component4 />
      <Frame8 />
    </div>
  );
...
function ImgRenwu5() {
  return (
    <div className="mr-[-6px] relative shrink-0 size-[84px]" data-name="img_renwu_1">
      <div className="absolute h-[74.975px] left-[-6.3px] top-[3.15px] w-[92.678px]" data-name="热血少年漫">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function ImgRenwu6() {
  return (
    <div className="mr-[-4px] relative shrink-0 size-[84px]" data-name="img_renwu_1">
      <div className="absolute h-[74.975px] left-0 top-[3.15px] w-[87.818px]" data-name="港漫风格">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Frame10() {
  return (
    <div className="content-stretch flex items-center mr-[-184px] pr-[4px] relative shrink-0">
      <ImgRenwu6 />
      <div className="css-g0mm18 flex flex-col font-['PingFang_SC:Semibold',sans-serif] justify-center leading-[0] mr-[-4px] not-italic relative shrink-0 text-[#454646] text-[26px] text-right">
...
function ImgRenwu7() {
  return (
    <div className="mr-[-4px] relative shrink-0 size-[84px]" data-name="img_renwu_1">
      <div className="absolute h-[74.975px] left-[2.1px] top-[1.05px] w-[82.959px]" data-name="美式漫画">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function ImgRenwu8() {
  return (
    <div className="mr-[-4px] relative shrink-0 size-[84px]" data-name="img_renwu_1">
      <div className="absolute h-[74.975px] left-[1.05px] top-[3.15px] w-[83.653px]" data-name="水彩插画">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
...
function Frame12() {
  return (
    <div className="content-stretch flex items-center mr-[-184px] pr-[4px] relative shrink-0">
      <ImgRenwu8 />
      <div className="css-g0mm18 flex flex-col font-['PingFang_SC:Semibold',sans-serif] justify-center leading-[0] mr-[-4px] not-italic relative shrink-0 text-[#404040] text-[26px] text-right">
...
function ImgRenwu9() {
  return (
    <div className="mr-[-4px] relative shrink-0 size-[84px]" data-name="img_renwu_1">
      <div className="absolute h-[79.8px] left-[5.66px] top-[-2.38px] w-[78.322px]" data-name="铅笔素描">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
