import svgPaths from "./svg-llhy9dkwrj";
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-start min-h-px min-w-px relative">
      ...
      <div className="flex flex-[1_0_0] h-[38.148px] items-center justify-center min-h-px min-w-px relative" style={{ "--transform-inner-width": "68", "--transform-inner-height": "90" } as React.CSSProperties}>
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-start min-h-px min-w-px relative">
      ...
      <div className="flex flex-[1_0_0] h-[38.148px] items-center justify-center min-h-px min-w-px relative" style={{ "--transform-inner-width": "65", "--transform-inner-height": "90" } as React.CSSProperties}>
        <div className="flex-none scale-y-[98%] skew-x-[-12deg] w-full">
          <div className="flex flex-col font-['PingFang_SC:Medium',sans-serif] justify-center leading-[0] not-italic relative text-[#464f5d] text-[26px] w-full">
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-start min-h-px min-w-px relative">
      ...
      <div className="flex flex-[1_0_0] h-[38.148px] items-center justify-center min-h-px min-w-px relative" style={{ "--transform-inner-width": "68", "--transform-inner-height": "68" } as React.CSSProperties}>
        <div className="flex-none scale-y-[98%] skew-x-[-12deg] w-full">
          <div className="flex flex-col font-['PingFang_SC:Medium',sans-serif] justify-center leading-[0] not-italic relative text-[#464f5d] text-[26px] w-full">
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-start min-h-px min-w-px relative">
      ...
      <div className="flex flex-[1_0_0] h-[38.148px] items-center justify-center min-h-px min-w-px relative" style={{ "--transform-inner-width": "61", "--transform-inner-height": "90" } as React.CSSProperties}>
        <div className="flex-none scale-y-[98%] skew-x-[-12deg] w-full">
          <div className="flex flex-col font-['PingFang_SC:Medium',sans-serif] justify-center leading-[0] not-italic relative text-[#464f5d] text-[26px] w-full">
