import svgPaths from "./svg-pqncm819nv";
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[3.305px] items-start left-[35.34px] overflow-clip top-[808.98px] w-[248.452px]">
      <Frame />
      <div className="flex h-[29.441px] items-center justify-center min-w-full relative shrink-0 w-[min-content]" style={{ "--transform-inner-width": "160", "--transform-inner-height": "23" } as React.CSSProperties}>
