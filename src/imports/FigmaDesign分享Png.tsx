import svgPaths from "./svg-yadkpt4c2o";
...
function Frame3() {
  return (
    <div className="absolute content-stretch flex gap-[9.687px] items-center left-[180px] top-[23px]">
      ...
      <div className="flex h-[27.994px] items-center justify-center leading-[0] relative shrink-0 w-[102.27px]" style={{ "--transform-inner-width": "360", "--transform-inner-height": "323.5" } as React.CSSProperties}>
