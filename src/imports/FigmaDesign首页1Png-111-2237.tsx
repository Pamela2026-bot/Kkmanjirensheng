import svgPaths from "./svg-tiz03u7qeq";
...
import imgGroups1 from "figma:asset/9355696ed92268585733ce1b02e7fbec3f19ee42.png";
    ...
    <div className="h-[60px] relative shrink-0 w-full" data-name="标题">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[40px] relative size-full">
          <div className="css-g0mm18 flex flex-col font-['PingFang_SC:Semibold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#443831] text-[34px]">
            <p className="css-ew64yg leading-[normal]">选择漫画风格</p>
          </div>
        </div>
      </div>
    </div>
...
function Component2() {
  return (
    <div className="absolute h-[83px] right-0 top-[calc(50%+0.5px)] translate-y-[-50%] w-[217px]" data-name="Component 6">
...
function Component5() {
  return (
    <div className="absolute h-[83px] right-0 top-[calc(50%+0.5px)] translate-y-[-50%] w-[217px]" data-name="Component 6">
      <div className="absolute bg-white h-[56px] left-[45px] rounded-[12px] top-[calc(50%-0.5px)] translate-y-[-50%] w-[160px]">
        <div aria-hidden="true" className="absolute border-3 border-black border-solid inset-[-1.5px] pointer-events-none rounded-[13.5px]" />
      </div>
    </div>
  );
...
function Component6() {
  return (
    <div className="absolute h-[83px] right-0 top-[calc(50%+0.5px)] translate-y-[-50%] w-[217px]" data-name="Component 6">
      <div className="absolute bg-white h-[56px] left-[30px] rounded-[12px] top-[calc(50%+0.5px)] translate-y-[-50%] w-[175px]">
        <div aria-hidden="true" className="absolute border-3 border-black border-solid inset-[-1.5px] pointer-events-none rounded-[13.5px]" />
      </div>
    </div>
  );
...
function Groups2() {
  return (
    <div className="h-[417px] relative shrink-0 w-full" data-name="Groups">
...
function ButtoGroups() {
  return (
    <div className="absolute bottom-[2px] content-stretch flex items-start justify-center left-[-1px] overflow-clip pb-[90px] pt-[20px] w-[750px]" data-name="butto_groups">
      <button />
    </div>
  );
}

export default function FigmaDesign1Png() {
  return (
    <div className="bg-white relative size-full" data-name="Figma design - 首页1.png">
      ...
      <div className="absolute h-[147px] left-0 top-[153px] w-[750px]" data-name="Groups 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgGroups1} />
      </div>
    </div>
  );
}