import svgPaths from "./svg-29v1hzf604";
...
import imgObject from "figma:asset/8a236b41fcc536ee2a95aaf59b863376cb5f2def.png";
import imgObject2 from "figma:asset/26087c36c252dad9d9cbe2575865117bfd817c9f.png";
import imgObject5 from "figma:asset/dd151cc861b755a11882478d7a084695490a4658.png";
import imgObject6 from "figma:asset/c8cdab74cbf3629a856e555ab54c43761ad17ca0.png";
...
function ImageGroup() {
  return (
    <div className="[grid-area:1_/_1] grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] ml-0 mt-0 place-items-start relative" data-name="Image Group">
      <div className="[grid-area:1_/_1] h-[24.671px] ml-[49.07px] mt-[1.64px] relative w-[27.138px]" data-name="Object">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[99.59%] left-[0.15%] max-w-none top-[0.41%] w-[99.48%]" src={imgObject} />
        </div>
      </div>
      <div className="[grid-area:1_/_1] h-[26.33px] ml-[77.46px] mt-0 relative w-[24.658px]" data-name="Object 2">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[99.42%] left-[0.45%] max-w-none top-[0.42%] w-[99.14%]" src={imgObject2} />
        </div>
      </div>
      <div className="[grid-area:1_/_1] h-[27.391px] ml-0 mt-[0.02px] relative w-[24.553px]" data-name="Object 5">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[99.58%] left-[0.14%] max-w-none top-[0.29%] w-[99.63%]" src={imgObject5} />
        </div>
      </div>
      <div className="[grid-area:1_/_1] h-[20.696px] ml-[22.89px] mt-[4.25px] relative w-[25.356px]" data-name="Object 6">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[99.57%] left-[0.1%] max-w-none top-[0.36%] w-[99.81%]" src={imgObject6} />
        </div>
      </div>
    </div>
  );
    ...
    <div className="absolute content-stretch flex gap-[9.687px] items-center left-[180px] top-[23px]">
      ...
      <div className="relative shrink-0 size-[8.325px]" data-name="Union">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.32529 8.32533">
          <path d={svgPaths.p1a281b00} fill="var(--fill-0, #1E1E1E)" id="Union" />
        </svg>
      </div>
      <div className="flex h-[27.996px] items-center justify-center leading-[0] relative shrink-0 w-[102.27px]" style={{ "--transform-inner-width": "360", "--transform-inner-height": "323.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[359.672deg]">
          <Group />
        </div>
      </div>
    </div>
...
function Frame5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[3px] items-start left-[37px] top-[938px] w-[227.156px]">
      <div className="flex h-[30.007px] items-center justify-center relative shrink-0 w-[351.154px]" style={{ "--transform-inner-width": "272", "--transform-inner-height": "22.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[359.672deg]">
          <p className="font-['PingFang_SC:Medium',sans-serif] leading-[normal] not-italic relative text-[20.12px] text-black tracking-[0.5px] whitespace-pre">写下你的故事，一键生成专属四格漫画</p>
        </div>
      </div>
      <div className="flex h-[26.299px] items-center justify-center min-w-full relative shrink-0 w-[min-content]" style={{ "--transform-inner-width": "128", "--transform-inner-height": "22.5" } as React.CSSProperties}>
        <div className="flex-none rotate-[359.672deg] w-full">
          <p className="font-['PingFang_SC:Regular',sans-serif] leading-[normal] not-italic opacity-30 relative text-[18px] text-black tracking-[1px] w-full whitespace-pre-wrap">扫描二维码可体验</p>
        </div>
      </div>
    </div>
  );
...
function Frame2() {
  return (
    <div className="h-[1039px] overflow-clip relative shrink-0 w-full">
...
function Frame1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[48px] items-center left-[55.45px] top-[155.81px] w-[640px]">
      <Frame2 />
      <Frame />
      <IcClosure />
    </div>
...
export default function FigmaDesignPng() {
  return (
    <div className="relative size-full" data-name="Figma design - 分享.png">
      <div className="absolute backdrop-blur-[25px] backdrop-filter bg-[rgba(0,0,0,0.6)] h-[1624px] left-0 top-[-0.19px] w-[750px]" data-name="gaosimohu" />
      <Frame1 />
    </div>
  );
}